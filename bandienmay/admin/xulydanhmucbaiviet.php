<?php
	...
	if(isset($_POST['themdanhmuc'])){
		...
		$tendanhmuc = $_POST['danhmuc'];
		$sql_update = mysqli_query($con,"UPDATE tbl_danhmuc_tin SET tendanhmuc ='$tendanhmuc' WHERE danhmuc_tin_id = '$id_post'" ) ;
		header('Location:xulydanhmucbaiviet.php');
	}
	if(isset($_GET['xoa'])){
		$id = $_GET['xoa'];
		$sql_xoa = mysqli_query($con,"DELETE FROM tbl_danhmuc_tin WHERE danhmuc_tin_id = '$id'");
	}
?>
		...
		<div class="row">
			<?php 
				if(isset($_GET['quanly'])=='capnhat'){
					$id_capnhat = $_GET['id'];
					$sql_capnhat = mysqli_query($con,"SELECT * FROM tbl_danhmuc_tin WHERE danhmuc_tin_id = '$id_capnhat'");
					...
					<form action="" method="POST">
						...
						<input type="hidden" class="form-control" name="id_danhmuc" value="<?php echo $row_capnhat['danhmuc_tin_id'] ?>"> <br>
			...
			<div class="col-md-7">
				...
				<?php
					$sql_select = mysqli_query($con,"SELECT * FROM tbl_danhmuc_tin ORDER BY danhmuc_tin_id DESC") 
				?>
				...
				<tr>
					...
					<td><a href="?xoa=<?php echo $row_category['danhmuc_tin_id']?>">Xóa</a> || <a href="?quanly=capnhat&id=<?php echo $row_category['danhmuc_tin_id']?>">Cập nhật</a></td>
				</tr>
				<?php 
				}
				?>
