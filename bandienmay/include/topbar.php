<?php
	...
	if(isset($_POST['dangnhap_home'])) {
		...
		if($taikhoan=='' || $matkhau ==''){
			echo '<script>alert("Làm ơn không để trống")</script>';
		}else{
			...
			if($count>0){
				$_SESSION['dangnhap_home'] = $row_dangnhap['name'];//lấy phiên đăng nhập dựa vào name ở khách hàng
				$_SESSION['khachhang_id'] = $row_dangnhap['khachhang_id'];
			
				header('Location: index.php?quanly=giohang ');//không cần location để n không load trang lại
			}else{
					...
					<ul>
						...
						<li class="text-center border-right text-white">
							<a href="index.php?quanly=xemdonhang&khachhang=<?php echo $_SESSION['khachhang_id']?>"  class="text-white">
								<i class="fas fa-truck mr-2"></i>Track Order: <?php echo $_SESSION['dangnhap_home']?></a>
						</li>
						<?php
						}
						?>
						...
						<li class="text-center border-right text-white">
							<i class="fas fa-phone mr-2"></i> 0945246026
						</li>
						<li class="text-center border-right text-white">
			...
			<div class="modal-content">
				...
				<div class="modal-body">
					<form action="#" method="post">
						...
						<div class="right-w3l">
							<input type="submit" class="form-control" name="dangnhap_home" value="Log in">
						</div>
						<div class="sub-w3l">
				...
				<div class="col-md-3 logo_agile">
					<h1 class="text-center">
						<a href="index.php" class="font-weight-bold font-italic">
							<img src="images/logo2.png" alt=" " class="img-fluid"> Store
						</a>
					</h1>
				</div>
				<!-- //logo -->
