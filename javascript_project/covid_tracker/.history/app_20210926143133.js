...
function getContryById(e){
    ...
    .then(data => {
        ...
        if(data.location.province!=""){
            ...
            document.getElementById('title_country').innerText = quocgia.toLocaleString('en')+'-'+data.location.province;
        }else{
            document.getElementById('quocgia').innerHTML = quocgia.toLocaleString('en');
            document.getElementById('title_country').innerText= quocgia.toLocaleString('en');
        }
